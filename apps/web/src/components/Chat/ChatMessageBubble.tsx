...
export function ChatMessageBubble({ msg, isOwn, onRetry }: Props) {
  ...
  return (
    <div
      className={cn(
        "group relative flex items-start gap-2.5 sm:gap-3 py-2.5 sm:py-3 lg:py-3.5  transition hover:bg-paper-soft/20",
      )}
    >
      ...
      >
        ...
        {msg.pending ? (
          ...
          <p
            className={cn(
              "text-[0.88rem] sm:text-[0.95rem] lg:text-base text-foreground/85 leading-snug mt-0.5 break-words whitespace-pre-wrap ",
